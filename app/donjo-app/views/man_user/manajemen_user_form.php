								...
								<div class="col-sm-8">
									<select class="form-control input-sm required" id="id_grup" name="id_grup">
										<?php if ($user['id_grup'] != '1'): ?>
											<option value="5" <?php if ($user['id_grup'] == '5'): ?>selected<?php endif ?>>Sekretaris Desa</option>
											<option value="4" <?php if ($user['id_grup'] == '4'): ?>selected<?php endif ?>>Kontributor</option>
											<option value="3" <?php if ($user['id_grup'] == '3' ): ?>selected<?php endif ?>>Kepala Desa</option>
